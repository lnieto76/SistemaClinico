...
<center><h3>..::Expediente Clinico::..</h3></center>
	...
	echo "</table><br><br>Imprimir --><input type=submit style=\"background-image:url(print.png); background-color:#000000;\" value='         ' onClick=\"window.open('print_reporte.php?id=$_POST[id_Paciente]','','toolbar=0,location=0,directories=0,status=0,scrollbars=1,resizable=0,copyhistory=0,menuBar=0,width=500,height=1000')\" target='_self'>
	";
}
?>
